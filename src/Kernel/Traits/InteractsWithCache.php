...
trait InteractsWithCache
{
	...
	{
		if (empty(array_intersect([SimpleCacheInterface::class, CacheItemPoolInterface::class],
		...
		if ($cache instanceof CacheItemPoolInterface) {
			if (!$this->isSymfony43OrHigher()) {
				throw new InvalidArgumentException(sprintf('The cache instance must implements %s',
