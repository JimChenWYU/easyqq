...
class ArrTest extends TestCase
{
    ...
    {
        $array = Arr::add(['name' => 'EasyQQ'], 'price', 100);
        self::assertSame(['name' => 'EasyQQ', 'price' => 100], $array);
    }
    ...
    {
        list($keys, $values) = Arr::divide(['name' => 'EasyQQ']);
        self::assertSame(['name'], $keys);
        self::assertSame(['EasyQQ'], $values);
    }
    ...
    {
        $array = ['name' => 'EasyQQ', 'price' => 100];
        $array = Arr::except($array, ['price']);
        self::assertSame(['name' => 'EasyQQ'], $array);
    }
    ...
    {
        $array = ['name' => 'EasyQQ', 'price' => 100, 'orders' => 10];
    ...
    public function testRandom()
    {
        ...
        self::assertIsArray($randomValues);
    ...
    public function testForget()
    {
        ...
        // Only works on first level keys
        $array = ['i@example.com' => 'Joe', 'i@easyqq.com' => 'Jane'];
        Arr::forget($array, 'i@example.com');
        self::assertSame(['i@easyqq.com' => 'Jane'], $array);
        // Does not work for nested keys
