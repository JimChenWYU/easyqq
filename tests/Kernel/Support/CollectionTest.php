...
class CollectionTest extends TestCase
{
    ...
    {
        $data = new Collection(['first' => 'overtrue', 'last' => 'Otwell', 'email' => 'jimchen@easyqq.com']);
        self::assertSame(['first' => 'overtrue'], $data->only(['first', 'missing'])->all());
        self::assertSame(['first' => 'overtrue', 'email' => 'jimchen@easyqq.com'], $data->only(['first', 'email'])->all());
    }

    public function testExcept()
    {
        $data = new Collection(['first' => 'overtrue', 'last' => 'Otwell', 'email' => 'jimchen@easyqq.com']);
        self::assertSame(['first' => 'overtrue'], $data->except(['last', 'email', 'missing'])->all());
        self::assertSame(['first' => 'overtrue'], $data->except('last', 'email', 'missing')->all());
        self::assertSame(['first' => 'overtrue', 'email' => 'jimchen@easyqq.com'], $data->except(['last'])->all());
        self::assertSame(['first' => 'overtrue', 'email' => 'jimchen@easyqq.com'], $data->except('last')->all());
    }
    ...
    public function testHas()
    {
        ...
        self::assertFalse($c->has('overtrue'));
    }
    ...
    public function testBasicFeatures()
    {
        ...
        $c['name'] = 'Hello';
        self::assertSame(['name' => 'Hello', 'age' => 25], $c->__set_state(['name' => 'Hello', 'age' => 25]));
    }
}
